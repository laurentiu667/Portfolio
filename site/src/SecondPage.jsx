    ...
    return (
        <>
            ...
            <section className="container-project">
                ...
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Reiciendis natus, excepturi est atque libero totam! Saepe
                    animi perspiciatis dignissimos quia.
                </p>
            ...
            <div className="passion">
                <h1>
                    My Passion for Keyboards: A Journey with the Neo Ergo F1 8X
                    V2 and Cycle7
                </h1>
                <p>
                    Discover how the Neo Ergo F1 8X V2 and Cycle7 keyboards fuel
                    my enthusiasm for mechanical keyboards and ergonomic typing.
                </p>
            </div>
            ...
            <div className="info-bottom">
                ...
                <p>
                    For more information on my competencies, click on the social
                    links below
                </p>
                <ul>
                    <li>
            ...
            <footer className="footer">
                <p>
                    &copy; 2024 Laurentiu Dilion. All rights reserved. For more
                    information, visit my social media profiles or contact me
                    directly.
                </p>
            </footer>
        </>
