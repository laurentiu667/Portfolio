import image from "../img/creative-dev.jpg";
function FirstPage() {
    return (
        <>
            <nav className="nav">
                <div className="nom">
                    <a href="#">Laurentiu Dilionsadasdasd</a>
                </div>
            ...
            <section className="info-page">
                <div className="info-text">
                    <div className="info-top">
                        <h1>Creative FullStack Web & Mobile Developer</h1>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Velit officia accusantium dicta eum impedit.
                            Ullam ipsum perferendis officia placeat non.
                        </p>
                        <div className="container-button">
                            ...
                            <button className="bt-hithub gh-button-general gh-button-general-wh">
                                <svg
                                    viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="#000000"
